...
class AbbrevRepr(humanreadable.BetterRepr):
    ...
    def repr_str(self, obj, level, could_be_base32_encoded_l=base32.could_be_base32_encoded_l, nulltrans=nulltrans, printableascii=printableascii, abbrev=abbrev):
        if len(obj) == 20:
