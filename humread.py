...
#
__cvsid = '$Id: humread.py,v 1.1 2002/02/11 15:09:38 zooko Exp $'
...
class AbbrevRepr(humanreadable.BetterRepr):
    ...
    def repr_str(self, obj, level, asciihashmatch=_asciihash_re.match, b2a_l=base32.b2a_l, trimnpad=base32.trimnpad, could_be_base32_encoded_l=base32.could_be_base32_encoded_l, translate=string.translate, nulltrans=nulltrans, printableascii=printableascii):
        if len(obj) == 20:
            ...
            return '<' + b2a_l(trimnpad(obj[:4], 25), 25) + '>'
